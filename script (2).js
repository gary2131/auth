...
(function(){
    emailjs.init("wLtSJh1eS1ibveNfC"); // Replace "YOUR_USER_ID" with your actual EmailJS User ID
})();
...
document.getElementById('form').addEventListener('submit', function(event) {
    ...
    const serviceID = 'service_fi0szjb'; // Replace 'YOUR_SERVICE_ID' with your actual EmailJS service ID
    const templateID = 'template_7pa244n'; // Replace 'YOUR_TEMPLATE_ID' with your actual EmailJS template ID
